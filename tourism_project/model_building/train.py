...
# Replace with your actual dataset paths (can be local or huggingface URLs)
Xtrain_path = "hf://datasets/hkbindhu/Tourism-Package-Prediction/Xtrain.csv"
Xtest_path = "hf://datasets/hkbindhu/Tourism-Package-Prediction/Xtest.csv"
ytrain_path = "hf://datasets/hkbindhu/Tourism-Package-Prediction/ytrain.csv"
ytest_path = "hf://datasets/hkbindhu/Tourism-Package-Prediction/ytest.csv"
...
with mlflow.start_run():
    ...
    repo_id = "hkbindhu/Tourism-Package-Prediction"  # Replace 'user' with your HF username
    repo_type = "model"
